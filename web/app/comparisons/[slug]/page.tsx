...
export default async function ComparisonPage({ params }: Props) {
  ...
  // Render the Instapage vs Unbounce article
  if (slug === "instapage-vs-unbounce") {
    return (
              ...
              <article className="prose prose-zinc dark:prose-invert max-w-none">
                ...
                <figure className="my-10">
                  <Image
                    ...
                    alt="Instapage vs Unbounce feature comparison table showing pricing, A/B testing, heatmaps, and ad integrations (2026)"
                    width={1200}
                    height={800}
